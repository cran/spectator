...
This functionality is available only for Sentinel-1, Sentinel-2 and Landsat-8 satellites.
It is based on the files provided by ESA (Sentinel-1, Sentinel-2) and USGS (Landsat-8), 
For Sentinels the acquisition plans usually have a range of 10-15 days, while for Landsat-8 it is 2-4 days.
...
[Landsat-8](https://landsat.usgs.gov/landsat_acq).  
